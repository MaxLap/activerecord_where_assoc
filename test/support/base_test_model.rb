...
class BaseTestModel < ActiveRecord::Base
  ...
  def self.testable_association(macro, association_name, given_scope = nil, **options, &block)
    ...
    send(macro, association_name, scope, **options, &block)
  end

  def self.testable_has_many(association_name, given_scope = nil, **options, &block)
    raise "association_name should start with 'm'" unless association_name.to_s.start_with?("m")
    testable_association(:has_many, association_name, given_scope, **options, &block)
  end
  ...
  def self.testable_has_and_belongs_to_many(association_name, given_scope = nil, **options, &block)
    raise "association_name should start with 'z'" unless association_name.to_s.start_with?("z")
    testable_association(:has_and_belongs_to_many, association_name, given_scope, **options, &block)
  end
